...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置系统服务" tabindex="-1"><a class="header-anchor" href="#配置系统服务" aria-hidden="true">#</a> 配置系统服务</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/systemd/system/loki.service
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装采集组件-安装在被采集主机" tabindex="-1"><a class="header-anchor" href="#安装采集组件-安装在被采集主机" aria-hidden="true">#</a> 安装采集组件(安装在被采集主机)</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://github.com/grafana/loki/releases/download/v2.5.0/promtail-linux-amd64.zip
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /data/promtail/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="grafana添加数据源" tabindex="-1"><a class="header-anchor" href="#grafana添加数据源" aria-hidden="true">#</a> grafana添加数据源</h3><p>即可在grafana界面通过LogQL语法或者鼠标点选条件，去筛选条件。</p><figure><img src="https://s2.loli.net/2022/08/11/E4aAWkNCeunwtXy.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,22),d=[l];function r(t,c){return s(),e("div",null,d)}const v=n(i,[["render",r],["__file","Grafana日志聚合工具Loki搭建.html.vue"]]);export{v as default};
