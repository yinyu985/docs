import{_ as d,W as s,X as r,Z as a,$ as e,Y as t,a0 as n,D as l}from"./framework-373472b1.js";const c={},u=n(`<h1 id="mysql基础总结" tabindex="-1"><a class="header-anchor" href="#mysql基础总结" aria-hidden="true">#</a> MySQL基础总结</h1><h2 id="登录数据库" tabindex="-1"><a class="header-anchor" href="#登录数据库" aria-hidden="true">#</a> 登录数据库</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mysql -u root -p
-u指定用户
-h指定登录的主机IP，不写就是本机。
-p写密码的
