import{_ as s,W as n,X as a,a0 as e}from"./framework-373472b1.js";const l={},i=e(`<h1 id="每隔一秒输出证明进程存活" tabindex="-1"><a class="header-anchor" href="#每隔一秒输出证明进程存活" aria-hidden="true">#</a> 每隔一秒输出证明进程存活</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">i</span><span class="token operator">=</span><span class="token number">1</span>
