import{_ as s,W as e,X as n,a0 as a}from"./framework-373472b1.js";const i={},t=a(`<h1 id="记录两种形式的heredocument" tabindex="-1"><a class="header-anchor" href="#记录两种形式的heredocument" aria-hidden="true">#</a> 记录两种形式的heredocument</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@ip-172-31-13-117:~<span class="token comment"># cat &gt;&gt; /etc/rancher/k3s/registries.yaml &lt;&lt;EOF</span>
