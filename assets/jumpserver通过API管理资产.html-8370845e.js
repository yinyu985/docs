import{_ as e,W as n,X as i,a0 as s}from"./framework-373472b1.js";const d={},l=s(`<h1 id="jumpserver通过api管理资产" tabindex="-1"><a class="header-anchor" href="#jumpserver通过api管理资产" aria-hidden="true">#</a> jumpserver通过API管理资产</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#!/usr/bin/env python3
# coding=UTF-8
