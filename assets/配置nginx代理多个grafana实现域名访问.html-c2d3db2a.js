import{_ as i,W as r,X as s,Z as e,$ as n,Y as d,a0 as l,D as t}from"./framework-373472b1.js";const o={},v=l(`<h1 id="配置nginx代理多个grafana实现域名访问" tabindex="-1"><a class="header-anchor" href="#配置nginx代理多个grafana实现域名访问" aria-hidden="true">#</a> 配置nginx代理多个grafana实现域名访问</h1><h2 id="目的" tabindex="-1"><a class="header-anchor" href="#目的" aria-hidden="true">#</a> 目的：</h2><h4 id="通过nginx服务器对grafana进行代理-根据不同的路由可以访问不同的grafana" tabindex="-1"><a class="header-anchor" href="#通过nginx服务器对grafana进行代理-根据不同的路由可以访问不同的grafana" aria-hidden="true">#</a> 通过Nginx服务器对grafana进行代理，根据不同的路由可以访问不同的grafana</h4><p>修改Nginx配置(nginx.conf)文件，添加访问grafana的配置</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>     upstream grafana-it {
