import{_ as i,W as t,X as l,Y as s,Z as n,$ as e,a0 as o,a1 as p,D as c}from"./framework-ab2cdc09.js";const d={},r={href:"https://zh.wikipedia.org/wiki/Nginx",target:"_blank",rel:"noopener noreferrer"},u={href:"https://zh.wikipedia.org/wiki/Lua",target:"_blank",rel:"noopener noreferrer"},m={href:"https://zh.wikipedia.org/wiki/%E6%B7%98%E5%AE%9D%E7%BD%91",target:"_blank",rel:"noopener noreferrer"},v={href:"https://zh.wikipedia.org/wiki/Cloudflare",target:"_blank",rel:"noopener noreferrer"},b=p(`<h3 id="openresty下载安装包" tabindex="-1"><a class="header-anchor" href="#openresty下载安装包" aria-hidden="true">#</a> OpenResty下载安装包</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /home/resource <span class="token operator">&amp;&amp;</span> <span class="token function">wget</span> https://openresty.org/download/openresty-1.19.9.1.tar.gz   <span class="token comment">#下载安装包到/home/resource</span>
...
<span class="token function">tar</span>  <span class="token parameter variable">-xf</span> master.tar.gz 
...
<span class="token parameter variable">-j8</span><span class="token comment">#用全部的两个核心去编译#我们的机器就俩核心</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h3><p>56、57 正常运行时，访问VIP时，显示master</p><blockquote><p>图片没了自己脑补</p></blockquote><p>停止56，查看keepalived状态，也顺利的被脚本停掉了，再访问VIP时</p><blockquote><p>图片没了自己脑补</p></blockquote><h3 id="添加模块" tabindex="-1"><a class="header-anchor" href="#添加模块" aria-hidden="true">#</a> 添加模块</h3><p>测试成功</p><p>假如用了一段时间，发现想要的功能忘了编译进去，可以重新编译。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx1 /<span class="token punctuation">]</span><span class="token comment"># nginx -V  #查看现有的nginx编译的参数，在此基础上添加</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后make，完成后/home/resource/openresty-1.19.9.1/build/nginx-1.19.9/objs这个路径下面会有一个nginx的可执行文件 备份好原来的，然后用这个替换。再用nginx -V检查新模块是不是已经加进来了。</p>`,46);function k(h,_){const a=c("ExternalLinkIcon");return t(),l("div",null,[s("p",null,[n("OpenResty是一个基于"),s("a",r,[n("Nginx"),e(a)]),n("的Web平台，可以使用其LuaJIT引擎执行"),s("a",u,[n("Lua"),e(a)]),n("指令码。由章亦春建立。2011年之前，它最初由"),s("a",m,[n("淘宝网"),e(a)]),n("赞助，2012年至2016年主要由"),s("a",v,[n("Cloudflare"),e(a)]),n("支援。自2017年起，主要得到OpenResty软体基金会和OpenResty公司的支援。OpenResty旨在构建可延伸的Web应用、Web服务和动态Web闸道器。OpenResty的架构是基于几个nginx模组，这些模组已经被扩充，以便将nginx扩充为一个web应用服务器，处理大量的请求。"),o("more")]),b])}const x=i(d,[["render",k],["__file","OpenResty-Keepalived组建高可用集群.html.vue"]]);export{x as default};
