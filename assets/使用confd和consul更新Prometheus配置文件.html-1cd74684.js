import{_ as e,W as s,X as l,a0 as n}from"./framework-b4edc447.js";const o={},t=n(`<h1 id="使用confd和consul更新prometheus配置文件" tabindex="-1"><a class="header-anchor" href="#使用confd和consul更新prometheus配置文件" aria-hidden="true">#</a> 使用confd和consul更新Prometheus配置文件</h1><blockquote><ol><li>首先，确认您的Prometheus已设置好警报规则配置。可以在Prometheus的配置文件（prometheus.yml）中添加以下内容：</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># prometheus.yml
# ...
rule_files:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>以上就是一个简单的示例，演示了如何使用 ConfD 从 Consul 中获取告警规则，并将其传递给 Prometheus。如果您有其他问题或需要进一步的帮助，请随时告诉我。</p>`,17),d=[t];function i(r,a){return s(),l("div",null,d)}const c=e(o,[["render",i],["__file","使用confd和consul更新Prometheus配置文件.html.vue"]]);export{c as default};
