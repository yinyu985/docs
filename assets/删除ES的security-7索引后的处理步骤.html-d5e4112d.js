import{_ as s,W as e,X as a,a1 as n}from"./framework-ab2cdc09.js";const t={},i=n(`<p>搭建了一套新环境，为了测试kibana配置ldap，并且对es中超大的索引进行导出存档。 在搭建的过程中发现，kiban连接es失败，网上查找资料后发现解决方案，发现只要删除.security-7这个索引就能够清除之前设置的密码，重新设置。.security-7索引中应该包含了用户登录等一些信息。利用curl命令执行删除索引的操作时，删除了另外一个测试环境的该索引，删除后，一切认证相关的功能全都失效，kibana无法登录，查找资料进行恢复。<!--more--> 编辑<code>elasticsearch.yml</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>cluster.name: es_cluster
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建一个超级用户，这个用户不会存进索引所以不受影响，</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>bin/elasticsearch-users <span class="token function">useradd</span> restore_user <span class="token parameter variable">-p</span> Xhs@12345678 <span class="token parameter variable">-r</span> superuser
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,8),r=[i];function c(l,o){return e(),a("div",null,r)}const u=s(t,[["render",c],["__file","删除ES的security-7索引后的处理步骤.html.vue"]]);export{u as default};
