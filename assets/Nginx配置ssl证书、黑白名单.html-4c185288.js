import{_ as i,W as t,X as l,Y as n,Z as s,$ as c,a1 as a,D as p}from"./framework-ab2cdc09.js";const o={},r=a(`<p>HTTP 协议由于其简单快速、占用资源少，是一种用于分布式、协作式和超媒体信息系统的应用层协议,是互联网数据通信的基础。一直被用于网站服务器和浏览器之间进行数据传输。HTTP是互联网数据通信的基础,但是在数据传输的过程中也存在很明显的问题，由于 HTTP 是明文协议，不会对数据进行任何方式的加密。<!--more--></p><p>当黑客攻击窃取了网站服务器和浏览器之间的传输报文的时，可以直接读取传输的信息，造成网站、用户资料的泄密。因此 HTTP 不适用于敏感信息的传播，这个时候需要引入 HTTPS（超文本传输安全协议）。</p><h3 id="https" tabindex="-1"><a class="header-anchor" href="#https" aria-hidden="true">#</a> HTTPS</h3><p>HTTPS（Hypertext Transfer Protocol Secure ）是一种以计算机网络安全通信为目的的传输协议。在HTTP下加入了SSL层，从而具有了保护交换数据隐私和完整性和提供对网站服务器身份认证的功能，简单来说它就是安全版的 HTTP 。</p><h3 id="在nginx服务器上安装证书" tabindex="-1"><a class="header-anchor" href="#在nginx服务器上安装证书" aria-hidden="true">#</a> 在Nginx服务器上安装证书</h3><p>您可以将已签发的SSL证书安装到Nginx或Tengine服务器上。本文介绍如何下载SSL证书并在Nginx或Tengine服务器上安装证书。</p><p>编辑Nginx配置文件（nginx.conf），修改与证书相关的配置。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#以下属性中，以ssl开头的属性表示与证书配置有关。</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="设置http请求自动跳转https" tabindex="-1"><a class="header-anchor" href="#设置http请求自动跳转https" aria-hidden="true">#</a> 设置HTTP请求自动跳转HTTPS</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="或者可以这样" tabindex="-1"><a class="header-anchor" href="#或者可以这样" aria-hidden="true">#</a> 或者可以这样</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen <span class="token number">80</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还有其他网页服务器，其他语言的写法，不赘述了。</p><h3 id="记录一个ssl配置生成器" tabindex="-1"><a class="header-anchor" href="#记录一个ssl配置生成器" aria-hidden="true">#</a> 记录一个ssl配置生成器</h3>`,14),d=n("strong",null,"SSL Configuration Generator",-1),u={href:"https://ssl-config.mozilla.org/",target:"_blank",rel:"noopener noreferrer"},m=a(`<h3 id="nginx的黑白名单" tabindex="-1"><a class="header-anchor" href="#nginx的黑白名单" aria-hidden="true">#</a> nginx的黑白名单</h3><p>nginx提供了简单的基于IP的访问控制功能，比如我们要禁止<code>1.2.3.4</code>这个IP地址访问服务器，可以在配置文件中这样写：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>deny <span class="token number">1.2</span>.3.4<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>还有其他网页服务器，其他语言的写法，不赘述了。</p><h3 id="ssl-证书格式" tabindex="-1"><a class="header-anchor" href="#ssl-证书格式" aria-hidden="true">#</a> SSL 证书格式</h3><p>.csr Certificate Signing Request，即证书签名请求文件。证书申请者在生成私钥的同时也生成证书请求文件。把CSR文件提交给证书颁发机构后，证书颁发机构使用其根证书私钥签名就生成了证书公钥文件，也就是颁发给用户的证书。安装时可忽略该文件</p><p>.key 私钥，与证书一一配对</p><p>.crt .cert .cer 可以是二进制格式(der)，可以是文本格式(pem)。只包含证书，不保存私钥。一般Linux使用.crt后缀，.cer是windows后缀。</p><p>此外，可以将多级证书导入同一个证书文件中，形成一个包含完整证书链的证书</p><p>.pem</p><p>证书文件（可忽略该文件）</p><blockquote><p>配置ssl证书时，必要的是crt和key</p></blockquote>`,13);function v(b,h){const e=p("ExternalLinkIcon");return t(),l("div",null,[r,n("p",null,[d,s(),n("a",u,[s("https://ssl-config.mozilla.org/"),c(e)])]),m])}const g=i(o,[["render",v],["__file","Nginx配置ssl证书、黑白名单.html.vue"]]);export{g as default};
