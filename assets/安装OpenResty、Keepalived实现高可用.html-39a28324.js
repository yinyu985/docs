import{_ as n,W as s,X as a,a0 as e}from"./framework-373472b1.js";const i={},t=e(`<h1 id="安装openresty-keepalived实现高可用" tabindex="-1"><a class="header-anchor" href="#安装openresty-keepalived实现高可用" aria-hidden="true">#</a> 安装OpenResty&amp;Keepalived实现高可用</h1><h3 id="openresty下载安装包" tabindex="-1"><a class="header-anchor" href="#openresty下载安装包" aria-hidden="true">#</a> OpenResty下载安装包</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /home/resource <span class="token operator">&amp;&amp;</span> <span class="token function">wget</span> https://openresty.org/download/openresty-1.19.9.1.tar.gz   <span class="token comment">#下载安装包到/home/resource</span>
